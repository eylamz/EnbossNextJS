...
export function MapLinks({ mediaLinks, parkName }: MapLinksProps) {
  ...
  return (
    <section aria-labelledby="directions-heading" className="mt-6 pt-4 border-t border-border-dark/20 dark:border-text-secondary-dark/70">
      <h2 id="directions-heading" className="sr-only">{t('mapLinks.title')}</h2>
      <div className="flex flex-col space-y-4">
        <h3 className="font-semibold text-text dark:text-[#96b6c9] mb-2 flex items-center">
