...
const getOptimizedImageUrl = (originalUrl: string | undefined | null, width: number = 600, quality: number = 90): string => {
  // Return empty string if URL is not provided
  if (!originalUrl) return '';
  
  // Check if this is a Cloudinary URL
  if (typeof originalUrl === 'string' && originalUrl.includes('cloudinary.com')) {
