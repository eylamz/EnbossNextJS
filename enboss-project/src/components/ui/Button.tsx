...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-custom text-xs sm:text-sm font-medium transition-colors outlineTab disabled:pointer-events-none disabled:opacity-50 transition-colors duration-200",
  {
    variants: {
      variant: {
        ...
        brand: "rounded-xl bg-brand-main/10 dark:bg-brand-dark/15 text-brand-main dark:text-brand-dark   hover:bg-brand-main/15 dark:hover:bg-brand-dark/20",
        ...
        secondary: "btn text-header-text hover:text-header-text/80  dark:text-text-secondary-dark dark:hover:text-header-dark",
