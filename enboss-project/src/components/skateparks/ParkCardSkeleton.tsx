...
const ParkCardSkeleton = () => {
  return (
    <div className="h-fit shadow-container bg-input dark:bg-input-dark rounded-3xl overflow-hidden relative group select-none transform-gpu transition-all duration-200 animate-pulse">
      {/* Image skeleton */}
